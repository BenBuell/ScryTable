(function () {
  ...
  // iOS can keep the layout viewport at the browser chrome's full height while
  // the visible viewport changes as the address bar, keyboard, or orientation
  // changes. Keep the app's flex layouts tied to the visible viewport instead
  ...
  function syncViewportVars() {
    ...
    if (standalone) {
      ...
      rootStyle.removeProperty('--app-width');
    } else {
  ...
  window.syncScryTableViewport = syncViewportVars;
